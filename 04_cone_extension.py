"""
File:  04_cone_extension.py
Author: Leah Tajon

Purpose:
Check your understanding of parameters, arguments, and local variable scope by
fixing a program that won't run because the programmer tried to use variables that
were defined in a different function.
"""
