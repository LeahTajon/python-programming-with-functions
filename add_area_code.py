...
Assignment: Write a program named add_area_code.py that reads phone numbers
from a text file. Your program must add the area code "208-" to all phone numbers
that don't have an area code. 
"""
def main():
    try:
